...
//               value={name}
//               onChange={(e) => setName(e.target.value)}
//               className="mb-6 w-full rounded-3xl border bg-[#FCFDFE] py-3 px-5"
//             />
...
//               value={type}
//               onChange={(e) => setType(e.target.value)}
//               className="mb-6 block w-full rounded-3xl border bg-[#FCFDFE] py-3 px-5"
//             >
//               <option value="traveler">Traveler</option>
//               <option value="hotelOwner">Hotel Owner</option>
//               <option value="vehicleOwner">Vehicle Owner</option>
...
//               value={repeatPassword}
//               onChange={(e) => setRepeatPassword(e.target.value)}
//               className="mb-9 w-full rounded-3xl border bg-[#FCFDFE] py-3 px-5"
//             />

//             <button
//               type="submit"
//               className="mb-10 w-full font-bold rounded-3xl bg-[#41A4FF] py-3 px-5 text-white hover:bg-gray-600"
//             >
//               Sign Up
//             </button>
//           </form>
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("travely_user", JSON.stringify({
        name:name,
        mobile:mobile,
        country: country,
        type:type,
      ...
      <div className="py-10 lg:py-20 px-16 lg:px-96 md:px-64 flex flex-col text-center">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-6 flex justify-center items-center">
            <label htmlFor="file">
              Click to add profile picture <DriveFolderUploadOutlinedIcon />
            </label>
            <input
              type="file"
              id="file"
        ...
        <p className="text-base text-[#adadad] pb-20">
          Already a member yet?
          <Link
            to="/login"
            className="text-primary hover:underline ms-2 font-bold"
